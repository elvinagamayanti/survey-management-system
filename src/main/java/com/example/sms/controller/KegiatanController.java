...
// public String addKegiatan(@Valid KegiatanDto kegiatanDto, BindingResult
// result) {
// if (result.hasErrors()) {
// return "/operator/addKegiatan";
// }
...
// public String updateKegiatan(@Valid KegiatanDto kegiatanDto, BindingResult
// result) {
// if (result.hasErrors()) {
// return "/operator/updateKegiatan";
// }
...
// // List<TahapKegiatan> tahapanList =
// // tahapKegiatanService.getTahapanByKegiatan(kegiatan);
// // System.out.println("Found " + tahapanList.size() + " steps for kegiatan
// ID: "
// // + id);

// // // Get active tahap
// // Optional<TahapKegiatan> activeTahap =
// // tahapKegiatanService.getActiveStepByKegiatan(kegiatan);
// // System.out.println("Active tahap: " + (activeTahap.isPresent() ?
// // activeTahap.get().getTahap() : "None"));

// // // Calculate overall progress
// // int overallProgress =
// // tahapKegiatanService.calculateOverallProgress(kegiatan);
...
// // public String initializeSteps(@PathVariable("kegiatanId") Long kegiatanId,
// // RedirectAttributes redirectAttributes) {
// // try {
// // Kegiatan kegiatan = kegiatanService.findKegiatanById(kegiatanId);
// // tahapKegiatanService.initializeStepsForKegiatan(kegiatan);
// // redirectAttributes.addFlashAttribute("success", "Steps initialized
// // successfully");
// // } catch (Exception e) {
// // redirectAttributes.addFlashAttribute("error", "Error initializing steps: "
// +
// // e.getMessage());
// // }
...
// // @ResponseBody
// // public List<Map<String, Object>> getKegiatanSteps(@PathVariable("id") Long
// // id) {
// // Kegiatan kegiatan = kegiatanService.findKegiatanById(id);
// // List<TahapKegiatan> steps =
// // tahapKegiatanService.getTahapanByKegiatan(kegiatan);
