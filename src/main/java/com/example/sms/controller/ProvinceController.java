...
// public String addProvince(@Valid ProvinceDto provinceDto, BindingResult
// result) {
// if (result.hasErrors()) {
// return "/superadmin/addProvince";
// }
...
// // public String updateProvinceForm(@PathVariable("provinceId") Long
// provinceId,
// // Model model) {
...
// // public String updateProvince(@Valid ProvinceDto provinceDto, BindingResult
// result) {
// // if (result.hasErrors()) {
// // return "/superadmin/updateProvince";
// // }
...
// // public String getSatkersByProvince(@PathVariable("provinceCode") String
// provinceCode, Model model) {
// // List<Satker> satkers =
// provinceService.getSatkersByProvinceCode(provinceCode);
// // // ProvinceDto province =
// provinceService.cariProvinceByCode(provinceCode);
...
// // }
// @GetMapping("/superadmin/provinces/{provinceCode}/satkers")
// public String getSatkersByProvince(@PathVariable String provinceCode, Model
// model) {
